...
yum install -y git build-essential checkinstall autoconf pkg-config libtool libyaml-devel libesmtp-devel libpcap-devel pcre-devel geoip-devel gnutls-devel prelude-devel daq-devel glibc-static libestr-devel libfastjson-devel liblognorm-devel flex flow-tools rrdtool-devel rrdtool-perl
